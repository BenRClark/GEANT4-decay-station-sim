...
void Position_Selector() {
  ...
  if(event == 24 && eventx == 115) {
    ...
    if(Dont_Save) {
      ...
      printf("Saving to ''new_results_downstream/Clover_%d_Results.txt''",counter);
      stringstream ss;
      ss.str();
      string s1 = "new_results_downstream/Clover_";
  ...
  if(event == 24 && eventx == 102) {
    ...
    for(int n = 0; n<Peak_Locations.size(); n++) {
      ...
      //fit_low and fit_high are crucial for getting the proper fit. need to look at spectra and see how far behind and ahead of the peak you need to fit it.
      //set to 10 as defualt. they are 20 for testing
      int fit_low = 25;
      int fit_high = 25;
...
//Main function
void downstream_Clover_Analyzer() {
