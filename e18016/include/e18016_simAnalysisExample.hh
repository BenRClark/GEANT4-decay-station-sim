...
#ifndef e18016_simAnalysisExample_h
#define e18016_simAnalysisExample_h 1
...
class G4Track;
class G4Step;
class e18016_simAnalysisExampleMessenger;
...
//class e18016_simAnalysisExample : public e18016_simAnalysisManager {
class e18016_simAnalysisExample : public e18016_simAnalysisManager {
  
public:
  e18016_simAnalysisExample();
  ~e18016_simAnalysisExample();
...
public:
  ...
  void DetectorInfo(e18016_simDetectorConstruction*);
...
private:
  ...
  G4double daughter_energy, e18016_sim_energy;
  ...
  G4double max_strip_y;
    ...
    G4String volname;
    G4int volcopyno, e18016_simcopyno;

    G4double e18016_sim_edep, crystal_edep[68];
  ...
  G4int empty;
  e18016_simAnalysisExampleMessenger* analysisexample;
  ...
  TNtuple *e18016_simntup; // e18016_sim ntuple output
  TTree *e18016_simtree;
  TTree *e18016_siminfo;
 ...
 //BC - add histograms for Si Scintillator
  TH1D *hEnergyDepositSiScint[257];
  TH1D *hSiScint;
  TH2D *hposSi;
  TH3D *hposSi3D;
  int numScintSi;
