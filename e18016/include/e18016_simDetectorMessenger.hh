...
#ifndef e18016_simDetectorMessenger_h
#define e18016_simDetectorMessenger_h 1
...
class e18016_simDetectorMessenger: public G4UImessenger
{
  public:
    e18016_simDetectorMessenger(e18016_simDetectorConstruction*);
   ~e18016_simDetectorMessenger();
    
    void SetNewValue(G4UIcommand*, G4String);
    
  private:
    e18016_simDetectorConstruction* myDetector;
    
    G4UIdirectory*             e18016_simDir;
    ...
    G4UIcmdWithABool*          UseSiScintCmd;//BC - Si Scint e18016
