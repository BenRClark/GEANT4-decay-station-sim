...
#ifndef e18016_simDetectorHit_h
#define e18016_simDetectorHit_h 1
...
class e18016_simDetectorHit : public G4VHit
{
  public:

      e18016_simDetectorHit();
      ~e18016_simDetectorHit();
      e18016_simDetectorHit(const e18016_simDetectorHit &right);
      const e18016_simDetectorHit& operator=(const e18016_simDetectorHit &right);
      G4int operator==(const e18016_simDetectorHit &right) const;
...
typedef G4THitsCollection<e18016_simDetectorHit> e18016_simDetectorHitsCollection;

extern G4Allocator<e18016_simDetectorHit> e18016_simDetectorHitAllocator;

inline void* e18016_simDetectorHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) e18016_simDetectorHitAllocator.MallocSingle();
  return aHit;
}

inline void e18016_simDetectorHit::operator delete(void *aHit)
{
  e18016_simDetectorHitAllocator.FreeSingle((e18016_simDetectorHit*) aHit);
}
