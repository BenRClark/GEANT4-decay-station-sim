...
void analysis_comparison_brc339(){
  ...
  for(int i = 0; i < numcrystals; i++){
    ...
    infile.open(Form("e18016_Dec_7/Clover_%i_Results.txt",i));
    //infile.open(Form("my4thtrialresults_run1240/Clover_%i_Results.txt",i));

    if(!infile.is_open()) {
      cout << "File " << Form("e18016_Dec_7/Clover_%i_Results.txt",i) << " could not be opened, moving on....\n" ;
      //cout << "File " << Form("my4thtrialresults_run1240/Clover_%i_Results.txt",i) << " could not be opened, moving on....\n" ;
    } else {
  ...
  vector<int> simupcrystals = {40,41,42,43,12,13,14,15,20,21,22,23,44,45,36,47,8,9,10,11,36,37,38,39,48,49,50,51,24,25,26,27,60,61,62,63,56,57,58,59,64,65,66,67,68,69,70,71};
  // vector<int> simdowncrystals = {0,1,2,8,10,11,20,21,22,23,24,25,26,27};
  vector<int> simdowncrystals = {4,5,6,7,28,29,30,31,32,33,34,35,52,53,54,55};
 ...
 //initializing arrays for regions of interest
  ...
  One->Draw("ap");
  One->Write();
  One->GetYaxis()->SetRangeUser(0,*max_element(clover1,clover1+numE)*1.1);
  ...
  Two->Draw("ap");
  Two->Write();
  Two->GetYaxis()->SetRangeUser(0,*max_element(clover2,clover2+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Three->Draw("ap");
  Three->Write();
  Three->GetYaxis()->SetRangeUser(0,*max_element(clover3,clover3+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Four->Draw("ap");
  Four->Write();
  Four->GetYaxis()->SetRangeUser(0,*max_element(clover4,clover4+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Five->Draw("ap");
  Five->Write();
  Five->GetYaxis()->SetRangeUser(0,*max_element(clover5,clover5+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Six->Draw("ap");
  Six->Write();
  Six->GetYaxis()->SetRangeUser(0,*max_element(clover6,clover6+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Seven->Draw("ap");
  Seven->Write();
  Seven->GetYaxis()->SetRangeUser(0,*max_element(clover7,clover7+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Eight->Draw("ap");
  Eight->Write();
  Eight->GetYaxis()->SetRangeUser(0,*max_element(clover8,clover8+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Nine->Draw("ap");
  Nine->Write();
  Nine->GetYaxis()->SetRangeUser(0,*max_element(clover9,clover9+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Ten->Draw("ap");
  Ten->Write();
  Ten->GetYaxis()->SetRangeUser(0,*max_element(clover10,clover10+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Eleven->Draw("ap");
  Eleven->Write();
  Eleven->GetYaxis()->SetRangeUser(0,*max_element(clover11,clover11+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Twelve->Draw("ap");
  Twelve->Write();
  Twelve->GetYaxis()->SetRangeUser(0,*max_element(clover12,clover12+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Thirteen->Draw("ap");
  Thirteen->Write();
  Thirteen->GetYaxis()->SetRangeUser(0,*max_element(clover13,clover13+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Fourteen->Draw("ap");
  Fourteen->Write();
  Fourteen->GetYaxis()->SetRangeUser(0,*max_element(clover14,clover14+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Fifteen->Draw("ap");
  Fifteen->Write();
  Fifteen->GetYaxis()->SetRangeUser(0,*max_element(clover15,clover15+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
  ...
  Sixteen->Draw("ap");
  Sixteen->Write();
  Sixteen->GetYaxis()->SetRangeUser(0,*max_element(clover16,clover16+numE)*1.1);
  // One->BuildLegend(0.8,0.8,0.9,0.9);
