...
void FitEfficiencyUpstream()
{
  ...
  Double_t scale = 34./30.; // Crystals in experiment divided by crystal calibration files
  Double_t x[12] = {42.8,86.5,105.3,123.1,247.7,591.8,723.3,873.2,996.3,1004.7,1274.5,1596.4};
  Double_t ex[12] = {};
  // Yikes
  Double_t y[12] = {scale*SumEff(deff42),scale*SumEff(deff86),scale*SumEff(deff105),scale*SumEff(eff123),scale*SumEff(eff247),scale*SumEff(eff591),scale*SumEff(eff723),scale*SumEff(eff873),scale*SumEff(eff996),scale*SumEff(eff1004),scale*SumEff(eff1274),scale*SumEff(eff1596)};
  Double_t ey[12] = {scale*SumEffErr(deff42),scale*SumEffErr(deff86),scale*SumEffErr(deff105),scale*SumEffErr(deff123),scale*SumEffErr(deff247),scale*SumEffErr(deff591),scale*SumEffErr(deff723),scale*SumEffErr(deff873),scale*SumEffErr(deff996),scale*SumEffErr(deff1004),scale*SumEffErr(deff1274),scale*SumEffErr(deff1596)};
  ...
  auto gr = new TGraphErrors(12,x,y,ex,ey);
