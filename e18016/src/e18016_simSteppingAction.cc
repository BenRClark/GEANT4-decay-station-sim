...
e18016_simSteppingAction::e18016_simSteppingAction()
{ 
  //  G4cout<<"e18016_simSteppingAction"<<G4endl;
}
...
void e18016_simSteppingAction::UserSteppingAction(const G4Step* fStep) 
{
  //  G4cout<<"e18016_simSteppingAction UserSteppingAction"<<G4endl;
  if(fStep->GetTrack()->GetParentID()!=0){
    e18016_simTrackInformation *info = (e18016_simTrackInformation*)(fStep->GetTrack()->GetUserInformation());
...
//     G4int StepNo = fTrack->GetCurrentStepNumber();
 ...
 //     G4String particleName = fTrack->GetDefinition()->GetParticleName();
	...
	//  G4String particleName = fTrack->GetDefinition()->GetParticleName();
	  ...
	  //
	  //e18016_simAnalysisManager::getInstance()->AddParticle(particleName, energy, weight, time);
	}
      }
    }
  }
  ...
  if (fTrack->GetTrackID() != 1 ) {
	...
	//e18016_simAnalysisManager::getInstance()->AddEnergy(edep,weight,time);
      }
    }
  }
#endif  
