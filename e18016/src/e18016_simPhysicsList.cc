...
#include "e18016_simPhysicsList.hh"
#include "e18016_simPhysicsListMessenger.hh"

//#include "e18016_simPhysListParticles.hh"
#include "G4EmStandardPhysics.hh"
//#include "e18016_simPhysListEmLowEnergy.hh"
//#include "e18016_simPhysListHadron.hh"
...
e18016_simPhysicsList::e18016_simPhysicsList() : G4VModularPhysicsList()
{
  ...
  pMessenger = new e18016_simPhysicsListMessenger(this);
...
e18016_simPhysicsList::~e18016_simPhysicsList()
{
  delete pMessenger;
  delete raddecayList;
...
void e18016_simPhysicsList::ConstructParticle()
{
...
void e18016_simPhysicsList::ConstructProcess()
{
  AddTransportation();
  // em
...
// had
  ...
  G4cout << "### e18016_simPhysicsList::ConstructProcess is done" << G4endl;

}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void e18016_simPhysicsList::SelectPhysicsList(const G4String& name)
{
  if (verboseLevel>1) {
    G4cout << "e18016_simPhysicsList::SelectPhysicsList: <" << name << ">" << G4endl;
  }
  // default  Had physics
  if (name == "Hadron" && !hadPhysicsList) {
    // hadPhysicsList = new e18016_simPhysListHadron("hadron");
    ...
    //} else if (name == "LowEnergy_EM") {
      ...
      delete emPhysicsList;
      // emPhysicsList = new e18016_simPhysListEmLowEnergy("lowe-em");
      emPhysicsList = new G4EmLivermorePhysics();
      ...
      G4cout << "e18016_simPhysicsList WARNING wrong or unkonwn <" 
	     << name << "> Physics " << G4endl;
  }
}
...
void e18016_simPhysicsList::AddExtraBuilders(G4bool flagHP)
{
  nhadcomp = 5;
...
void e18016_simPhysicsList::SetCuts()
{
...
void e18016_simPhysicsList::SetCutForGamma(G4double cut)
{
  cutForGamma = cut;
...
void e18016_simPhysicsList::SetCutForElectron(G4double cut)
{
  cutForElectron = cut;
...
void e18016_simPhysicsList::SetCutForPositron(G4double cut)
{
  cutForPositron = cut;
...
void e18016_simPhysicsList::SetTargetCut(G4double cut)
{
...
void e18016_simPhysicsList::SetDetectorCut(G4double cut)
{
