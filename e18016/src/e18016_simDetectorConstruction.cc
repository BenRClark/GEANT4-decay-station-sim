...
#include "e18016_simDetectorMessenger.hh"
#include "e18016_simDetectorSD.hh"
...
e18016_simDetectorConstruction::e18016_simDetectorConstruction()
...
{
  //  G4cout<<"e18016_simDetectorConstruction"<<G4endl;
  detectorMessenger = new e18016_simDetectorMessenger(this);
  DefineMaterials();
...
void e18016_simDetectorConstruction::DefineMaterials()
{
  // G4cout<<"e18016_simDetectorConstruction DefineMaterials"<<G4endl;
  //--------- Material definition ---------
  ...
  materialsManager = new e18016_simMaterial();
  // Lead
  ...
  //BC - Si Scintillator material
  SiScint_Mater = materialsManager->GetMaterial("Si");
...
G4VPhysicalVolume* e18016_simDetectorConstruction::Construct()
{
  //--------- Definitions of Solids, Logical Volumes, Physical Volumes ---------
  //--------- Sizes of the principal geometrical components (solids)  ---------
  //G4cout<<"gedssdDetectorConstruction Contruct"<<G4endl;
 
  fWorldLength = fGeThickDetectorThickness + 400000.0*cm;
  fWorldRadius = fGeThickDetectorRadius + 1500000.0*cm;
  ...
  G4double CloverDeadLayerLength = 0.0001*mm;
  G4double CloverDeadLayerRadius = 0.0001*mm;
  G4double TotalCloverLength = 80*mm - CloverDeadLayerLength;
  G4double TotalCloverLength2 = 70*mm - CloverDeadLayerLength;
  G4double CloverCrystalLength = TotalCloverLength - CloverDeadLayerLength;
  G4double CloverCrystalLength2 = TotalCloverLength2 - CloverDeadLayerLength;
  //G4double CloverCrystalRadius = 22.5*mm; //union of cylinder and box geom
  G4double CloverCrystalRadius = 24*mm; // simple cyclinder geom
  G4double CloverDeadWasherInnerRad = CloverCrystalRadius - CloverDeadLayerRadius;
  //22.5
  ...
  //solidCloverBool3 = new G4Tubs("CloverBool3",0,CloverCrystalRadius,CloverCrystalLength2/2.,0,twopi);
  
  // continue with box
  G4double CloverCrystalBoxx = 2*CloverCrystalRadius;
  G4double CloverCrystalBoxy = 2*CloverCrystalRadius;
  G4double CloverCrystalBoxz = TotalCloverLength;
  G4double CloverCrystalBoxz2 = TotalCloverLength2;
  G4RotationMatrix *rotateclover = new G4RotationMatrix();
  rotateclover->rotateX(0.*deg);

  solidCloverBool2 = new G4Box("CloverBool2",CloverCrystalBoxx/2.,CloverCrystalBoxy/2.,CloverCrystalBoxz/2.);
  //solidCloverBool4 = new G4Box("CloverBool4",CloverCrystalBoxx/2.,CloverCrystalBoxy/2.,CloverCrystalBoxz2/2.);
  ...
  solidCloverCrystal = new G4Tubs("",0,CloverCrystalRadius-CloverDeadLayerRadius,CloverCrystalLength/2.,0,twopi);

  solidCloverCrystal2 = new G4Tubs("CloverCrystal2",0,CloverCrystalRadius-CloverDeadLayerRadius,(CloverCrystalLength2)/2.,0,twopi);

  solidCloverCrystalDeadLayer = new G4Tubs("",0,CloverCrystalRadius,CloverDeadLayerLength/2.,0,twopi);

  solidCloverCrystalDeadLayerWasher = new G4Tubs("",CloverDeadWasherInnerRad,CloverCrystalRadius,CloverCrystalLength/2.,0,twopi);

  solidCloverCrystalDeadLayerWasher2 = new G4Tubs("",CloverDeadWasherInnerRad,CloverCrystalRadius,CloverCrystalLength2/2.,0,twopi);

  logicCloverCrystal = new G4LogicalVolume(solidCloverCrystal,CloverCrystalMater,"CloverCrystal",0,0,0);

  logicCloverCrystal2 = new G4LogicalVolume(solidCloverCrystal2,CloverCrystalMater,"CloverCrystal2",0,0,0);

  //logicCloverCrystal2 = logicCloverCrystal; 

  logicCloverCrystalDeadLayer = new G4LogicalVolume(solidCloverCrystalDeadLayer,CloverCrystalMater,"CloverCrystalDeadLayer",0,0,0);

  logicCloverCrystalDeadLayerWasher = new G4LogicalVolume(solidCloverCrystalDeadLayerWasher, CloverCrystalMater,"CloverCrystalDeadLayerWasher",0,0,0);

  logicCloverCrystalDeadLayerWasher2 = new G4LogicalVolume(solidCloverCrystalDeadLayerWasher2, CloverCrystalMater,"CloverCrystalDeadLayerWasher",0,0,0);
  ...
  solidCloverCore2 = new G4Tubs("CloverCore2",0,CloverCoreRadius,CloverCrystalLength2/2.,0,twopi);
  logicCloverCore2 = new G4LogicalVolume(solidCloverCore2,VacuumMater,"CloverCore2",0,0,0);
  ...
  physiCloverCore2 = new G4PVPlacement(0,
				       CloverCorePos,
				       logicCloverCore2,
				       "CloverCore2",
				       logicCloverCrystal2,
  ...
  G4double CloverCryoz = 80*mm + 20.0*mm;
  CloverCryoz += - 0*mm; 

  solidCloverCryo = new G4Box("CloverCryo",CloverCryox/2.,CloverCryoy/2.,CloverCryoz/2.);
  solidCloverCryo2 = new G4Box("CloverCryo",CloverCryox/2.,CloverCryoy/2.,CloverCryoz/2.);
  
  logicCloverCryo = new G4LogicalVolume(solidCloverCryo,CloverCryoMater, "CloverCryo",0,0,0);
  logicCloverCryo2 = new G4LogicalVolume(solidCloverCryo2,CloverCryoMater, "CloverCryo",0,0,0);
  ...
  solidCloverCryoVac2 = new G4Box("CloverCryoVac",CloverCryoVacx/2.,CloverCryoVacy/2.,CloverCryoVacz/2.);
  logicCloverCryoVac = new G4LogicalVolume(solidCloverCryoVac,VacuumMater,"CloverCryoVac",0,0,0);
  logicCloverCryoVac2 = new G4LogicalVolume(solidCloverCryoVac2,VacuumMater,"CloverCryoVac",0,0,0);
  ...
  CloverCrystalPos = G4ThreeVector(CloverCrystalBoxx/2., CloverCrystalBoxy/2.,CloverDeadLayerLength/2.);
  physiCloverCrystal = new G4PVPlacement(rotateclover,
					 CloverCrystalPos,
					 logicCloverCrystal,
					 "CloverCrystal",
					 logicCloverCryoVac,
  ...
  CloverCrystalWasherPos = G4ThreeVector(CloverCrystalBoxx/2., CloverCrystalBoxy/2.,CloverDeadLayerLength/2. );
  physiCloverCrystalDeadWasher = new G4PVPlacement(rotateclover,
						   CloverCrystalWasherPos,
						   logicCloverCrystalDeadLayerWasher,
						   "CloverCrystalDeadLayerWasher",
						   logicCloverCryoVac,
						   false,
						   0);
  CloverCrystalWasherPos = G4ThreeVector(CloverCrystalBoxx/2., -CloverCrystalBoxy/2.,CloverDeadLayerLength/2.);
  ...
  CloverCrystalDeadPos = G4ThreeVector(CloverCrystalBoxx/2., CloverCrystalBoxy/2., -CloverCrystalBoxz/2. + CloverDeadLayerLength/2.);
  physiCloverCrystalDead = new G4PVPlacement(rotateclover,
					     CloverCrystalDeadPos,
					     logicCloverCrystalDeadLayer,
					     "CloverCrystalDeadLayer",
					     logicCloverCryoVac,
					     false,
					     0);
  CloverCrystalDeadPos = G4ThreeVector(-CloverCrystalBoxx/2., CloverCrystalBoxy/2., -CloverCrystalBoxz/2. + CloverDeadLayerLength/2.);
  ...
  CloverCryoVacuumPos = G4ThreeVector(0,0,0);
  physiCloverCryoVac2 = new G4PVPlacement(0,
					  CloverCryoVacuumPos,
					  logicCloverCryoVac2,
					  "CloverCryoVac",
					  logicCloverCryo2,
  ...
  CloverCrystalPos = G4ThreeVector(CloverCrystalBoxx/2., CloverCrystalBoxy/2.,CloverDeadLayerLength/2.);
  physiCloverCrystal2 = new G4PVPlacement(rotateclover,
					  CloverCrystalPos,
					  logicCloverCrystal2,
					  "CloverCrystal2",
					  logicCloverCryoVac2,
  ...
  CloverCrystalPos = G4ThreeVector(-CloverCrystalBoxx/2., CloverCrystalBoxy/2.,CloverDeadLayerLength/2.);
  physiCloverCrystal2 = new G4PVPlacement(0,
					  CloverCrystalPos,
					  logicCloverCrystal2,
					  "CloverCrystal2",
					  logicCloverCryoVac2,
  ...
  CloverCrystalWasherPos = G4ThreeVector(CloverCrystalBoxx/2., CloverCrystalBoxy/2.,CloverDeadLayerLength/2. );
  physiCloverCrystalDeadWasher2 = new G4PVPlacement(rotateclover,
						    CloverCrystalWasherPos,
						    logicCloverCrystalDeadLayerWasher2,
						    "CloverCrystalDeadLayerWasher",
						    logicCloverCryoVac2,
						    false,
						    0);
  ...
  CloverCrystalDeadPos = G4ThreeVector(CloverCrystalBoxx/2., CloverCrystalBoxy/2., -CloverCrystalBoxz2/2. + CloverDeadLayerLength/2.);
  physiCloverCrystalDead2 = new G4PVPlacement(rotateclover,
					      CloverCrystalDeadPos,
					      logicCloverCrystalDeadLayer,
					      "CloverCrystalDeadLayer",
					      logicCloverCryoVac2,
  ...
  //G4double distclover =13.208*cm + (CloverCryox/2.0); // if radial distance = 5.2 inches
  G4double distclover =14.00*cm + (CloverCryox/2.0); // if radial distance = 5.2 inches
  //G4double distclover =12.7*cm + CloverCryoz*0.5;
  // 15.9004*cm + (CloverCryox/2.0); //if radial distance = 6.26 inches

  G4cout << "Going into fUseClover" << G4endl;
  ...
  if(fUseClover){
    ...
    G4double Offset = 0.0*cm;
    G4double upOffset = 0.2*cm;
    G4double downOffset = 1.0*cm;
    G4double zOffset = 0.0*cm;
    G4double yOffset = 0.0*cm;

    
    for(int ii = 0; ii < 8; ii++){
      //if(distclover*cos(pi/4*ii) < 0.25*mm && distclover*cos(pi/4*ii) > -0.25*mm){
      if(distclover*cos(pi/4*ii) ==0){
	CloverCryoPos = G4ThreeVector( distclover*sin(pi/4*ii)*cos(0), distclover*sin(pi/4*ii)*sin(0)+yOffset, distclover*cos(pi/4*ii) + zOffset);
      }
      else if(distclover*cos(pi/4*ii) > 0){
	CloverCryoPos = G4ThreeVector( (distclover+Offset+downOffset)*sin(pi/4*ii)*cos(0), (distclover+Offset+downOffset)*sin(pi/4*ii)*sin(0), (distclover+Offset+downOffset)*cos(pi/4*ii) + zOffset);
      }
      else if(distclover*cos(pi/4*ii) < 0){
	CloverCryoPos = G4ThreeVector( (distclover+Offset+upOffset)*sin(pi/4*ii)*cos(0), (distclover-Offset+upOffset)*sin(pi/4*ii)*sin(0)+yOffset, (distclover-Offset+upOffset)*cos(pi/4*ii) + zOffset);
      }
      if(ii!=0 && ii!=4){
	if(ii == 6){
	...
	//added by me can be deleted if doesnt work
    ...
    for(int ii = 0; ii < 8; ii++){
      // if(distclover*cos(pi/4*ii) < 0.25*mm && distclover*cos(pi/4*ii) > -0.25*mm){
      if(distclover*cos(pi/4*ii) == 0){
	CloverCryoPos = G4ThreeVector(distclover*sin(pi/4*ii)*sin(0) , distclover*sin(pi/4*ii)*cos(0)+yOffset, distclover*cos(pi/4*ii) + zOffset);
      }
      else if(distclover*cos(pi/4*ii) > 0){
	CloverCryoPos = G4ThreeVector((distclover+Offset+downOffset)*sin(pi/4*ii)*sin(0) , (distclover+Offset+downOffset)*sin(pi/4*ii)*cos(0)+yOffset, (distclover+Offset+downOffset)*cos(pi/4*ii) + zOffset);
      }
      else if(distclover*cos(pi/4*ii) < 0){
	CloverCryoPos = G4ThreeVector((distclover+Offset+upOffset)*sin(pi/4*ii)*sin(0) , (distclover-Offset+upOffset)*sin(pi/4*ii)*cos(0)+yOffset, (distclover-Offset+upOffset)*cos(pi/4*ii) + zOffset);
      }
      if(ii!=0 && ii!=4){
	if(count==1 || count == 7 ){
    ...
    count=14;
    for(int ii = 0; ii < 8; ii++){
      CloverCryoPos = G4ThreeVector((distclover+Offset)*cos(pi/4*ii), (distclover+Offset)*sin(pi/4*ii)*cos(0)+yOffset, (distclover+Offset)*sin(pi/4*ii)*sin(0) + zOffset);
  ...
  //  fPipeOutRad = 5.715*cm;//actual measuremen
  fPipeOutRad = 7.73876*cm;//actual measurement got from Timi
  //fPipeOutRad = 5.87375*cm;
  //fPipeOutRad = 6.0325*cm;
  //fPipeOutRad = 6.19125*cm;
  //fPipeOutRad = 6.35*cm;
  //fPipeInRad = 5.3975*cm;
  //  fPipeInRad = 5.47624*cm; //from drawings 0.23876cm thck
  fPipeInRad = 7.5*cm;//got from Timi 7.5
  //fPipeLength = 50.8*cm + (40*cm);//Too long!
  fPipeLength = 30.735*cm -17*cm;// from drawings 30.735
  //fPipeLength = 39.6875*cm;
  //fPipeFacePlateInRad = 5.55864*cm;
  fPipeFacePlateInRad = 0*cm;
  //fPipeFacePlateOutRad = 5.715*cm;//should be the same as the actual pipe radius
  fPipeFacePlateOutRad = 7.73876*cm;//got from TimifPipeFacePlateOutRad = 5.715*cm
  fPipeFacePlateDepth = 0.025*cm- 0.024*cm;
  ...
  if(fUsePipe){
    ...
    //fPipe_zpos = 10.5438*cm -8*cm;
    fPipe_zpos = fPipeLength/2.0 - 4.5*mm;
    ...
    //fPipeFacePlate_zpos = fPipeFacePlateDepth/2.0 + fPipeLength/2.0-8*cm;
    fPipeFacePlate_zpos = fPipeFacePlateDepth/2.0 + fPipeLength/2.0;


    
    physiBCSpipe = new G4PVPlacement(0,
				     G4ThreeVector(0,0,fPipe_zpos),
				     logicBCSpipe,
				     "BCSpipe",
				     logicWorld,
				     false,
    ...
    physiBCSpipefaceplate = new G4PVPlacement(0,
					      G4ThreeVector(0,0,-fPipeFacePlate_zpos-fPipeFacePlateDepth/2.0),//10.5438 + 10.5438/2 -1
  ...
  flabr3AlCoveroutrad = 1.584375*cm;  //Diameter = 3.96875 cm or 1.5625 in
  ...
  fSiScintHeight = 40*mm;
  fSiScintWidth = 40*mm;
  fSiScintDepth = 1.0*mm;

  solidSiScint = new G4Box("SiScint", fSiScintWidth/2.0, fSiScintHeight/2.0, fSiScintDepth/2.0);
  logicSiScint = new G4LogicalVolume(solidSiScint,SiScint_Mater,"SiScint",0,0,0);
  
  //fCeBr3Scint_zpos = -2.278125*cm;
  //fCeBr3Scint_zpos = -2.02*cm;
  //fCeBr3Scint_zpos = -2.25*cm + (fCeBr3ScintDepth -3*mm)/2.0;
  fSiScint_zpos = 0*cm;//place at 0,0,0 for now
  G4cout << "fSiScint_zpos = " << fSiScint_zpos << G4endl;
  //fCeBr3Scint_zpos += 0.02*cm;
  //fCeBr3Scint_zpos = -2.0*cm;

  if(fUseSiScint){
  
    physiSiScint = new G4PVPlacement(0,
				     G4ThreeVector(innerDet_xpos,innerDet_ypos,fSiScint_zpos), //adjacent to SiScint
				     logicSiScint,
				     "SiScint",
				     logicWorld,
				     false,
  ...
  G4cout << "Front face of Si Scint = " << (fSiScint_zpos - fSiScintDepth/2.0) << G4endl;
  ...
  */
  ...
  //G4String detectorSDname = "e18016_sim/DetectorSD";
  G4String detectorSDname = "GeThickDetectorCollection";
  e18016_simDetectorSD* aDetectorSD = new e18016_simDetectorSD( detectorSDname );
  ...
  e18016_simDetectorSD* athinDetectorSD = new e18016_simDetectorSD( detectorSDname );
  ...
  e18016_simDetectorSD* aSegaDetectorSD = new e18016_simDetectorSD( detectorSDname );
  ...
  e18016_simDetectorSD* aCloverDetectorSD = new e18016_simDetectorSD( detectorSDname);
  SDman->AddNewDetector( aCloverDetectorSD);
  logicCloverCrystal->SetSensitiveDetector( aCloverDetectorSD);

  detectorSDname = "CloverCollection2";
  e18016_simDetectorSD* aCloverDetectorSD2 = new e18016_simDetectorSD( detectorSDname);
  SDman->AddNewDetector( aCloverDetectorSD2);
  logicCloverCrystal2->SetSensitiveDetector( aCloverDetectorSD2);

  //add other type of clover
  //  detectorSDname = "CloverCollection";
  //  e18016_simDetectorSD* aCloverDetectorSD2 = new e18016_simDetectorSD( detectorSDname);
  //  SDman->AddNewDetector( aCloverDetectorSD2);
  // logicCloverCrystal2->SetSensitiveDetector( aCloverDetectorSD2);
  ...
  e18016_simDetectorSD* aLaBr3DetectorSD = new e18016_simDetectorSD(detectorSDname);
  ...
  e18016_simDetectorSD* aGetestDetectorSD = new e18016_simDetectorSD(detectorSDname);
  ...
  e18016_simDetectorSD* aEXOtestDetectorSD = new e18016_simDetectorSD(detectorSDname);
  ...
  e18016_simDetectorSD* aEJ204ScintDetectorSD = new e18016_simDetectorSD(detectorSDname);
  ...
  e18016_simDetectorSD* aCeBr3ScintDetectorSD = new e18016_simDetectorSD(detectorSDname);
  ...
  //BC - add PSPMT+Si as sensitive detector
  detectorSDname = "SiScintCollection";
  e18016_simDetectorSD* aSiScintDetectorSD = new e18016_simDetectorSD(detectorSDname);
  SDman->AddNewDetector(aSiScintDetectorSD);
  logicSiScint->SetSensitiveDetector(aSiScintDetectorSD);
  G4cout << "sensitive 3.5 " << G4endl;
  ...
  logicCloverCrystalDeadLayer->SetVisAttributes(G4Colour::Red());
  ...
  if(ge18016_simAnalysisManager) ge18016_simAnalysisManager->DetectorInfo(this);
...
// void e18016_simDetectorConstruction::setTargetMaterial(G4String materialName)
// {
...
void e18016_simDetectorConstruction::setGeThickDetectorMaterial(G4String materialName)
{
  // search the material by its name 
  G4Material* pttoMaterial = G4Material::GetMaterial(materialName);  
  if (pttoMaterial)
...
void e18016_simDetectorConstruction::setGeThinDetectorMaterial(G4String materialName)
{
  // search the material by its name 
  G4Material* pttoMaterial = G4Material::GetMaterial(materialName);  
  if (pttoMaterial)
