...
//#include "e18016_simMaterialData.hh"
#include "e18016_simMaterialMessenger.hh"
...
////////////////////////////////////////////////////////////////////////////////
//
e18016_simMaterial::e18016_simMaterial ()
{
  ...
  // Elements
  // G4cout<<"e18016_simMaterial"<<G4endl;
  ...
  materialMessenger = new e18016_simMaterialMessenger(this);
}
////////////////////////////////////////////////////////////////////////////////
//
e18016_simMaterial::~e18016_simMaterial ()
...
//
/*
  void e18016_simMaterial::AddMaterial (G4String name, G4String formula, G4double density,
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //
  void e18016_simMaterial::DeleteMaterial (G4int j)
  {
  size_t i(j-1);
  if (i > Material.size()) {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //
  void e18016_simMaterial::DeleteMaterial (G4String )
  {
  G4cerr <<"It seems there is no mechanism in G4 for deleting a material yet!"
  <<G4endl;
  G4cerr <<"--> Command rejected." <<G4endl;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //
  G4int e18016_simMaterial::GetMaterialIndex (G4String name)
  {
  size_t i ;
  for (i = 0; i < Material.size(); i++) {
...
////////////////////////////////////////////////////////////////////////////////
//
void e18016_simMaterial::ListMaterial ()
{
