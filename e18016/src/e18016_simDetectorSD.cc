...
e18016_simDetectorSD::e18016_simDetectorSD(G4String name)
  :G4VSensitiveDetector(name), HCID(-1)
{  
  // G4cout<<"e18016_simDetectorSD"<<G4endl;
  G4String HCname;
...
e18016_simDetectorSD::~e18016_simDetectorSD(){;
  // G4cout<<"~e18016_simDetectorSD"<<G4endl;
}

void e18016_simDetectorSD::Initialize(G4HCofThisEvent*HCE)
{
  // G4cout<<"e18016_simDetectorSD Initialize"<<G4endl;
  //static int HCID = -1;
  scintCollection = new e18016_simDetectorHitsCollection
...
G4bool e18016_simDetectorSD::ProcessHits(G4Step*aStep,G4TouchableHistory*ROhist)
{
  // G4cout<<"e18016_simDetectorSD ProcessHits"<<G4endl;
  ...
  // G4cout<<" Before '' aHit = new e18016_simDetectorHit();'' "<<G4endl; 
  
  aHit = new e18016_simDetectorHit();
  ...
  //   e18016_simTrackInformation *info = (e18016_simTrackInformation*)(aStep->GetTrack()->GetUserInformation());
  ...
  else if(volname == "CloverCrystal2"){
    //   G4cout<<"SD ProcessHits Clover"<<G4endl;
    G4int crystalcopyno = aStep->GetPreStepPoint()->GetTouchableHandle()->GetVolume(0)->GetCopyNo();
    G4int Cloverno = aStep->GetPreStepPoint()->GetTouchableHandle()->GetVolume(2)->GetCopyNo();
    G4int volcopyno = Cloverno * 4 + crystalcopyno;
...
void e18016_simDetectorSD::EndOfEvent(G4HCofThisEvent*)
{;}

void e18016_simDetectorSD::clear()
{
} 

void e18016_simDetectorSD::DrawAll()
{
} 

void e18016_simDetectorSD::PrintAll()
{
} 
