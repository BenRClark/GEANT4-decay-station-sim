...
e18016_simDetectorMessenger::e18016_simDetectorMessenger(e18016_simDetectorConstruction* myDet)
:myDetector(myDet)
{ 
  // G4cout<<"gedssdnrDetectorMessenger"<<G4endl;
  e18016_simDir = new G4UIdirectory("/e18016_sim/");
  e18016_simDir->SetGuidance("UI commands specific to this example.");
  
  detDir = new G4UIdirectory("/e18016_sim/det/");
  detDir->SetGuidance("detector control.");
  
  GeThickDetectorThicknessCmd = new G4UIcmdWithADoubleAndUnit("/e18016_sim/det/setGeThickDetectorThickness",this);
  ...
  GeThickDetectorRadiusCmd = new G4UIcmdWithADoubleAndUnit("/e18016_sim/det/setGeThickDetectorRadius",this);
  ...
  GeThickDetectorMatCmd = new G4UIcmdWithAString("/e18016_sim/det/setGeThickDetectorMate",this);
  ...
  GeThinDetectorThicknessCmd = new G4UIcmdWithADoubleAndUnit("/e18016_sim/det/setGeThinDetectorThickness",this);
  ...
  GeThinDetectorRadiusCmd = new G4UIcmdWithADoubleAndUnit("/e18016_sim/det/setGeThinDetectorRadius",this);
  ...
  GeThinDetectorMatCmd = new G4UIcmdWithAString("/e18016_sim/det/setGeThinDetectorMate",this);
  ...
  DetectorSpacingCmd = new G4UIcmdWithADoubleAndUnit("/e18016_sim/det/setDetectororSpacing",this);
  ...
  UseGeThickDetectorCmd = new G4UIcmdWithABool("/e18016_sim/det/UseGeThickDetector",this);
  ...
  UseGeThinDetectorCmd = new G4UIcmdWithABool("/e18016_sim/det/UseGeThinDetector",this);
  ...
  UseGeThickDetectorCryoCmd = new G4UIcmdWithABool("/e18016_sim/det/UseGeThickDetectorCryo",this);
  ...
  UseGeThickDetectorCryoEndCapCmd = new G4UIcmdWithABool("/e18016_sim/det/UseGeThickDetectorCryoEndCap",this);
  ...
  UseSegaCmd = new G4UIcmdWithABool("/e18016_sim/det/UseSega",this);
  ...
  UseCloverCmd = new G4UIcmdWithABool("/e18016_sim/det/UseClover",this);
  ...
  UseLaBr3Cmd = new G4UIcmdWithABool("/e18016_sim/det/UseLaBr3",this);
  ...
  UseLaBr3FrameCmd = new G4UIcmdWithABool("/e18016_sim/det/UseLaBr3Frame",this);
  ...
  Use3HenCmd = new G4UIcmdWithABool("/e18016_sim/det/Use3Hen",this);
  ...
  //BC - use MTC
  UseMTCCmd = new G4UIcmdWithABool("/e18016_sim/det/UseMTC",this);
  UseMTCCmd->SetGuidance("activate MTC");
  UseMTCCmd->SetParameterName("choice",false);
  UseMTCCmd->AvailableForStates(G4State_PreInit);
  
  //BC - use LENDA
  UseLENDACmd = new G4UIcmdWithABool("/e18016_sim/det/UseLENDA",this);
  ...
  //BC - use Getest
  UseGetestCmd = new G4UIcmdWithABool("/e18016_sim/det/UseGetest",this);
  ...
  UseEXOtestCmd = new G4UIcmdWithABool("/e18016_sim/det/UseEXOtest",this);
  ...
  UseEJ204ScintCmd = new G4UIcmdWithABool("/e18016_sim/det/UseEJ204Scint",this);
  ...
  //BC - use PSPMT
  UsePSPMTCmd = new G4UIcmdWithABool("/e18016_sim/det/UsePSPMT",this);
  ...
  //BC - use SiDSSD
  UseSiDSSDCmd = new G4UIcmdWithABool("/e18016_sim/det/UseSiDSSD",this);
  ...
  //BC - use beam pipe
  UsePipeCmd = new G4UIcmdWithABool("/e18016_sim/det/UsePipe",this);
  ...
  UseCeBr3ScintCmd = new G4UIcmdWithABool("/e18016_sim/det/UseCeBr3Scint",this);
 ...
 //BC - use Si Scintillator
  UseSiScintCmd = new G4UIcmdWithABool("/e18016_sim/det/UseSiScint",this);
  UseSiScintCmd ->SetGuidance("activate Si Scintillator");
  UseSiScintCmd ->SetParameterName("choice",false);
  UseSiScintCmd ->AvailableForStates(G4State_PreInit);
...
e18016_simDetectorMessenger::~e18016_simDetectorMessenger()
{
  //G4cout<<"~gedssdnrDetectorMessenger"<<G4endl;
  ...
  delete UseSiScintCmd;
  
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void e18016_simDetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{ 
 ...
 else if (command == UseSiScintCmd )
    { myDetector->setUseSiScint(UseSiScintCmd->GetNewBoolValue(newValue));}
